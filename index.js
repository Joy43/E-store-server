...
// -------------connect  bd--------------
const productCollection = client.db("estore").collection("product");
const homeproductCollection = client.db("estore").collection("homeproduct");
const cartCollection=client.db("estore").collection("carts");
const userCollection=client.db("estore").collection("users");
const paymentCollection = client.db("estore").collection("payments");
...
app.get('/', (req, res) => {
    res.send('estore is sitting on')
  })
  
  app.listen(port, () => {
    console.log(`estore is sitting on port ${port}`);
  })